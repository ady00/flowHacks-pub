...
const Page = ({
  ...
  return (
    <div className='min-h-screen px-10 bg-gray-50'>
      ...
      <NextSeo
        title={noteHeading || 'JotMe note'}
        description={noteDescription}
        openGraph={{
          url: 'https://usejotme.vercel.app/p/' + publicId,
          title: noteHeading || 'JotMe',
          description:
            noteDescription ||
            'JotMe is more than just a note taking app. It is the only productivity tool you will ever need.',
          images: [
            {
              url: 'https://usejotme.vercel.app/ogimage.png',
            },
          ],
          site_name: noteHeading || 'JotMe',
        }}
        twitter={{
          handle: '@lalitcodes',
